...
try {
    ...
    $stmt = $pdo->prepare("SELECT * FROM etudiants WHERE niveau = :niveau AND statut = 'recalé' AND archive = 0");

    $stmt->execute(['niveau' => 'M1']);
...
<head>
    ...
    <title>Étudiants Recalés en Licence 1</title>
    <link rel="stylesheet" href="css/statut.css">
</head>
<body>
    <div class="container">
        <h1 class="title">Liste des Étudiants Recalés en Master 1</h1>
