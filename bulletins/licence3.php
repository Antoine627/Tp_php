...
try {
    ...
    $stmt->execute(['niveau' => 'L3']); // 1 correspond au niveau Licence 1
...
<body>
    <div class="container">
        <div class="btn-container">
            <div class="btn">
                <a href="admis_licence3.php"><button class="btn-stylized">Admis</button></a>
            </div>

            <div class="btn">
                <a href="recales_licence3.php"><button class="btn-stylized">Recalé</button></a>
            </div>
        </div>
